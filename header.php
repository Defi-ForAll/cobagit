...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> cakrasafety@gmail.com</li>
                <li>Siap Memberikan Berkah untuk Kamu yang Belanja dengan indah</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> cakrasafety@gmail.com</li>
                                <li>Belanja Dengan Indah Kami Berikan Berkah</li>
                            </ul>
                        </div>
                    </div>
