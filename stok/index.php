...
<head>
    ...
    <!-- Title -->
    <title>Aplikasi Stok Gudang Cakra Safety</title>
        ...
        <nav class="navbar navbar-expand-lg fixed-top bg-primary shadow">
            <div class="container-fluid px-lg-5">
                <span class="navbar-brand text-white">
                    ...
                    Aplikasi Stok Barang <span class="d-none d-md-inline">Cakra Safety</span>
                </span>
            </div>
        </nav>
    </header>
    ...
    <footer class="footer mt-auto bg-white shadow py-4">
        <div class="container-fluid px-lg-5">
            ...
            <div class="copyright text-center mb-2 mb-md-0">
                &copy; 2024 - <a href="cakrasafety.com" target="_blank" class="text-brand text-decoration-none">Cakra safety</a>Thank for Template to Pustaka Koding All rights reserved.
            </div>
        </div>
    </footer>
